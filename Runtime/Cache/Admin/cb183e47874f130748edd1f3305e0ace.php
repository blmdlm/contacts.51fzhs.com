...
<form  action="<?php echo U('Admin/Modify/userBasicInfo');?>">
<h3>用户基本信息</h3>
...
<h3>College info</h3>
<form action="<?php echo U('Admin/Modify/userCollegeInfo');?>" >
id:   <input type="text" name="id"  /><br />
...
<h3>Company info</h3>
<form action="<?php echo U('Admin/Modify/userCompanyInfo');?>">
id:   <input type="text" name="id"  /><br />
